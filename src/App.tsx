...
import {
  Plus, History, MessageSquare, ShieldAlert, RefreshCw, LogIn, LogOut, ShieldCheck, User as UserIcon,
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 md:px-8 space-y-8" id="content-container">
              {activeDigest ? (
                ...
                <div className="animate-fadeIn py-8" id="upload-stage-wrapper">
                  ...
                  <UploadZone onParsed={handleParsed} language={language} digests={digests} />
